              ...
              parts: [
                {
                  ...
                  5. CRITICAL: Once you have Name, Company, Challenges, and Email, you MUST call the 'submitInquiry' tool immediately.
                  6. DO NOT say "I will submit this" without actually calling the tool.
                  7. After the tool call is successful, say "I've submitted your inquiry. Someone will be in touch soon." and then say goodbye.
            ...
            try {
              ...
              const response = await fetch("/api/contact", {
                ...
                body: JSON.stringify({
                  name: fc.args.name,
                  email: fc.args.email,
                  subject: fc.args.company, // Mapping Company -> Subject
                  message: fc.args.challenges, // Mapping Challenges -> Message
                }),
              });
              ...
              if (response.ok) {
                ...
                // Optionally handle error - for now we let the AI know it failed?
                // Or just pretend it worked to be polite?
                // Let's tell the AI it failed so it can apologize.
                const toolResponse = {
                  toolResponse: {
                    functionResponses: [
                      {
